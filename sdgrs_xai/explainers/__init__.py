...
from sdgrs_xai.explainers.lrp import AttnLRPExplainer, CPLRPExplainer
from sdgrs_xai.explainers.shap import (
    KernelShapExplainer,
    PartitionShapExplainer,
    TfIdfPartitionShapExplainer,
)
from sdgrs_xai.explainers.gradient import (
    GradientExplainer,
    IntegratedGradientExplainer,
)
from sdgrs_xai.explainers.lime import LimeExplainer
from sdgrs_xai.explainers.model import ExplainerMethod
...
def get_explainer(method_name, model, tokenizer, device, model_family, tfidf_corpus_path=None):
    ...
    if method == ExplainerMethod.SHAP_PARTITION_TFIDF:
        ...
        return ExplainerClass(model_family, model, tokenizer, device, max_seq_len)
    else:
